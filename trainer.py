...
class Trainer:
    ...
    def init_model(self):
        model = self.structure.builder.build(self.device, self.experiment.distributed, self.experiment.local_rank)
        return model
    ...
    def train(self):
        ...
        while True:
            ...
            for batch in train_data_loader:
                ...
                if self.experiment.validation and self.steps % self.experiment.validation.interval == 0 and self.steps > self.experiment.validation.exempt:
